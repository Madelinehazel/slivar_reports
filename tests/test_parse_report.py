...
multicano_refseq = 'ZMYM6/missense_variant/ENST00000357182/ENSG00000163867/YES/16/16/ENST00000357182.4:c.2912A>C/ENSP00000349708.4:p.Asn971Thr/971/1325/missense_variant/benign(0.062)/deleterious(0)/Pfam:PF14291&PANTHER:PTHR11697&PANTHER:PTHR11697:SF92&Superfamily:SSF53098;ZMYM6NB/upstream_gene_variant/ENST00000373337/ENSG00000243749/YES/////upstream_gene_variant///;ZMYM6/intron_variant/ENST00000373340/ENSG00000163867///ENST00000373340.2:c.2146+4064A>C///intron_variant///;RP11-244H3.1/upstream_gene_variant/ENST00000417456/ENSG00000241014//////upstream_gene_variant///;RP11-244H3.4/intron_variant&NMD_transcript_variant/ENST00000487874/ENSG00000271741/YES//ENST00000487874.1:c.2146+4064A>C///intron_variant&NMD_transcript_variant///;ZMYM6/non_coding_transcript_exon_variant/ENST00000493328/ENSG00000163867//15/15/ENST00000493328.1:n.4236A>C///non_coding_transcript_exon_variant///;TMEM35B/upstream_gene_variant/NM_001195156.1/100506144/YES/////upstream_gene_variant///;ZMYM6/missense_variant/NM_007167.4/9204/YES/16/16/NM_007167.4:c.2912A>C/NP_009098.3:p.Asn971Thr/971/1325/missense_variant/benign(0.062)/deleterious(0)/'
...
def test_parse_inf():
    ...
    assert(
        parse_functions.parse_inf(cano_refseq) == ['MORN1:NM_024848.3:c.790G>A:p.Val264Met', 'NM_024848.3','c.790G>A','p.Val264Met','9_14','264_497','NA','probably_damaging(0.939)','deleterious(0.02)','Yes']
    )
    assert(
        parse_functions.parse_inf(multicano_refseq) == ['TMEM35B:NM_001195156.1:NA:NA,ZMYM6:NM_007167.4:c.2912A>C:p.Asn971Thr', 'NM_001195156.1', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'Yes']
    )
    assert(
        parse_functions.parse_inf(refseq) == ['ELMO1:NM_001206480.2:c.-74+3_-74+6dup:NA', 'NM_001206480.2', 'c.-74+3_-74+6dup', 'NA', 'NA', 'NA', 'NA', 'NA', 'NA', 'No']
    )
    assert(
